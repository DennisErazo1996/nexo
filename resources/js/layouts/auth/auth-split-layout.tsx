    ...
    return (
        <div className="relative grid min-h-svh flex-col items-center justify-center lg:max-w-none lg:grid-cols-12 lg:px-0">
            ...
            <div className="relative hidden h-full flex-col justify-between overflow-hidden bg-[#1A2B44] p-10 text-white lg:col-span-5 lg:flex xl:col-span-4 dark:border-r dark:border-border/40">
                ...
                <div className="pointer-events-none absolute -right-24 -bottom-24 h-96 w-96 rounded-full bg-sky-500/10 blur-3xl" />
                ...
                <div className="relative z-20 my-auto space-y-6 py-10">
                    <div className="inline-flex items-center gap-2 rounded-full border border-[#a3bd31]/30 bg-[#a3bd31]/10 px-3.5 py-1 text-xs font-semibold tracking-wider text-[#a3bd31] uppercase">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-sm leading-relaxed text-slate-300/90">
                            Organiza el inventario inmobiliario, gestiona los
                            requerimientos de tus clientes y genera
                            coincidencias automáticas en un solo lugar.
                        </p>
                    </div>
                    ...
                    <div className="space-y-3.5 pt-2">
                        <div className="flex items-start gap-3 text-sm text-slate-200">
                            ...
                            <span>
                                Inventario centralizado de inmuebles con fichas
                                técnicas y fotos.
                            </span>
                        </div>
                        <div className="flex items-start gap-3 text-sm text-slate-200">
                            ...
                            <span>
                                Registro de clientes con presupuesto, zonas y
                                seguimiento.
                            </span>
                        </div>
                        <div className="flex items-start gap-3 text-sm text-slate-200">
                            ...
                            <span>
                                Cruce inteligente entre oferta y demanda
                                inmobiliaria.
                            </span>
                        </div>
                    </div>
                ...
                <div className="relative z-20 text-xs text-slate-400">
                    &copy; {new Date().getFullYear()} Nexo. Todos los derechos
                    reservados.
                </div>
            </div>
