        ...
        <>
            ...
            <div className="min-h-screen bg-background text-foreground selection:bg-[#a3bd31]/30 selection:text-foreground">
                ...
                <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur-md">
                    <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                        ...
                        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
                            ...
                            <a href="#coincidencias" className="transition-colors hover:text-foreground">
                ...
                <main>
                    ...
                    <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28">
                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mx-auto max-w-3xl text-center space-y-6">
                                <div className="inline-flex items-center gap-2 rounded-full border border-[#a3bd31]/30 bg-[#a3bd31]/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-wider text-[#1A2B44] dark:text-[#a3bd31]">
                                    <Sparkles className="h-3.5 w-3.5 text-[#a3bd31]" />
                                    <span>CRM Inmobiliario de Alto Rendimiento</span>
                                </div>
                                ...
                                <p className="text-base text-muted-foreground sm:text-sm lg:text-md leading-relaxed">
                                    Nexo es la bitácora inteligente que conecta en tiempo real los clientes compradores con las propiedades disponibles de tus agentes, eliminando las oportunidades perdidas.
                                </p>
                            ...
                            {/* Preview Mockup UI */}
                            <div className="mt-14 relative mx-auto max-w-5xl rounded-2xl border border-border/80 bg-card p-3 shadow-2xl md:p-4">
                                <div className="overflow-hidden rounded-xl border border-border/60 bg-muted/30">
                                    ...
                                    <div className="flex items-center justify-between border-b border-border/50 bg-card px-4 py-3">
                                        ...
                                        <div className="flex items-center gap-2 text-xs font-semibold text-primary">
                                            <span className="h-2 w-2 rounded-full bg-[#a3bd31] animate-pulse" />
                                    ...
                                    <div className="grid gap-4 p-4 sm:p-6 md:grid-cols-3">
                                        <div className="rounded-lg border border-border bg-card p-4 shadow-xs space-y-2">
                                            <div className="flex items-center justify-between text-muted-foreground">
                                                <span className="text-xs font-medium">Inventario Activo</span>
                                                <Building2 className="h-4 w-4 text-primary" />
                                            </div>
                                            <div className="text-2xl font-bold">148 Inmuebles</div>
                                            <p className="text-xs text-emerald-600 font-medium">+12 nuevas esta semana</p>
                                        </div>
                                        ...
                                        <div className="rounded-lg border border-border bg-card p-4 shadow-xs space-y-2">
                                            ...
                                            <div className="text-2xl font-bold">384 Contactos</div>
                                            <p className="text-xs text-emerald-600 font-medium">85 con presupuesto calificado</p>
                                        </div>

                                        <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 shadow-xs space-y-2">
                                            <div className="flex items-center justify-between text-primary">
                                                <span className="text-xs font-semibold uppercase tracking-wider">Coincidencias Listas</span>
                                                <Zap className="h-4 w-4 text-[#a3bd31]" />
                                            </div>
                                            <div className="text-2xl font-bold text-foreground">42 Cruces Directos</div>
                                            <p className="text-xs text-muted-foreground font-medium">Compradores esperando visita</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                                <div className="space-y-4">
                                    <div className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-destructive">
                                        <span>El problema clásico de las inmobiliarias</span>
                                    </div>
                                    <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                                        ¿Tus agentes usan hojas de Excel y grupos de WhatsApp caóticos?
                                    </h2>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Cuando un agente capta una propiedad y otro agente tiene al cliente perfecto, la venta no ocurre porque nadie sabe lo que el otro tiene registrado. Nexo soluciona este silo de información de inmediato.
                                    </p>
                                </div>
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    <div className="rounded-xl border border-border bg-card p-4 space-y-2">
                                        ...
                                        <h3 className="font-semibold text-sm">Archivos desactualizados</h3>
                                        <p className="text-xs text-muted-foreground">Precios viejos y propiedades ya vendidas que confunden al equipo.</p>
                                    </div>
                                    ...
                                    <div className="rounded-xl border border-primary/20 bg-card p-4 space-y-2">
                                        ...
                                        <h3 className="font-semibold text-sm">Cruce instantáneo Nexo</h3>
                                        <p className="text-xs text-muted-foreground">Todo el inventario y demanda conectados y sincronizados en tiempo real.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mx-auto max-w-2xl text-center space-y-3 mb-14">
                                ...
                                <p className="text-sm text-muted-foreground sm:text-base">
                                    Diseñado específicamente para el flujo real de agencias y corredores inmobiliarios.
                                </p>
                            </div>

                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {/* Feature 1 */}
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xs space-y-3 transition-all hover:shadow-md hover:border-primary/40">
                                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary">
                                        <Building2 className="h-5 w-5" />
                                    </div>
                                    <h3 className="text-lg font-bold text-foreground">Catálogo de Propiedades</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Registra inmuebles con galerías fotográficas, especificaciones técnicas, precio, tipo de moneda, ubicación y agente responsable.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xs space-y-3 transition-all hover:shadow-md hover:border-primary/40">
                                    ...
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Guarda los requerimientos exactos de cada comprador: presupuesto min/max, zonas deseadas, tipo de propiedad y estado de atención.
                                    </p>
                                </div>

                                {/* Feature 3 */}
                                <div className="rounded-2xl border border-[#a3bd31]/40 bg-[#a3bd31]/5 p-6 shadow-xs space-y-3 transition-all hover:shadow-md">
                                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#a3bd31]/20 text-[#a3bd31]">
                                        <Sparkles className="h-5 w-5" />
                                    </div>
                                    <h3 className="text-lg font-bold text-foreground">Motor de Coincidencias</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        El sistema evalúa de forma automática el catálogo contra las solicitudes de clientes y te avisa cuando existe compatibilidad de compra/alquiler.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xs space-y-3 transition-all hover:shadow-md hover:border-primary/40">
                                    ...
                                    <h3 className="text-lg font-bold text-foreground">Notas de Seguimiento</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Registra llamadas, visitas y comentarios en el expediente de cada cliente para que ningún contacto se quede sin atender.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xs space-y-3 transition-all hover:shadow-md hover:border-primary/40">
                                    ...
                                    <h3 className="text-lg font-bold text-foreground">Equipos y Roles</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Invita a tus agentes con enlaces firmados seguros. Administra qué agentes gestionan cada propiedad y cliente.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xs space-y-3 transition-all hover:shadow-md hover:border-primary/40">
                                    ...
                                    <h3 className="text-lg font-bold text-foreground">Métricas en Vivo</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Visualiza el embudo de clientes, propiedades más activas y desempeño del equipo desde el dashboard central.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="coincidencias" className="border-t border-border bg-muted/30 py-20">
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                                <div className="space-y-6">
                                    <div className="inline-flex items-center gap-2 rounded-full border border-[#a3bd31]/30 bg-[#a3bd31]/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-wider text-primary dark:text-[#a3bd31]">
                                        <Zap className="h-3.5 w-3.5" />
                                        <span>El corazón de Nexo</span>
                                    </div>

                                    <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                                        ¿Cómo funciona el motor de coincidencias automáticas?
                                    </h2>

                                    <p className="text-sm text-muted-foreground sm:text-base leading-relaxed">
                                        Cada vez que un agente da de alta un inmueble o registra los deseos de un nuevo prospecto, Nexo compara los parámetros y crea una relación directa:
                                    </p>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-sm">Cruce por Presupuesto y Moneda</h4>
                                                <p className="text-xs text-muted-foreground">Filtra automáticamente si el precio encaja dentro del rango del cliente.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-sm">Zona geográfica y Tipo de Inmueble</h4>
                                                <p className="text-xs text-muted-foreground">Casa, departamento, terreno o local en la colonia o sector buscado.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-sm">Notificación y Acción Inmediata</h4>
                                                <p className="text-xs text-muted-foreground">El agente puede contactar al cliente con la ficha exacta sin perder horas buscando.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-6 shadow-xl space-y-4">
                                    <div className="flex items-center justify-between border-b border-border pb-3">
                                        <span className="text-xs font-bold uppercase tracking-wider text-primary">Ejemplo de Coincidencia</span>
                                    ...
                                    <div className="space-y-3">
                                        <div className="rounded-lg bg-muted/60 p-3 text-xs space-y-1">
                                            <p className="font-bold text-foreground">Requerimiento de Cliente: Carlos Mendoza</p>
                                            <p className="text-muted-foreground">Busca: Casa en Venta · Presupuesto: $150,000 - $220,000 USD</p>
                                        </div>
                                        ...
                                        <div className="rounded-lg bg-primary/5 border border-primary/20 p-3 text-xs space-y-1">
                                            <p className="font-bold text-foreground">Inmueble Captado: Residencia Las Cumbres</p>
                                            <p className="text-muted-foreground">Precio: $195,000 USD · Agente captador: Sofía R.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-2 text-center">
                                        ...
                                        >
                                            Probar con tu propio inventario <ArrowRight className="h-3 w-3" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="bg-[#1A2B44] text-white py-16">
                        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center space-y-6">
                            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                                Empieza hoy a cruzar clientes y cerrar más ventas
                            </h2>
                            <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto">
                                Únete a los equipos inmobiliarios que ya dejaron atrás las hojas de cálculo y tienen su bitácora sincronizada con Nexo.
                            </p>
                            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                                <Link
                                    href={auth.user ? dashboard() : register()}
                                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-[#a3bd31] px-6 py-3.5 text-sm font-bold text-[#1A2B44] shadow-md transition-all hover:bg-[#a3bd31]/90 hover:scale-[1.02]"
                                >
                                    <span>{auth.user ? 'Ir a mi panel' : 'Crear mi equipo gratis'}</span>
                                    <ArrowRight className="h-4 w-4" />
                                </Link>
                                {!auth.user && (
                                    <Link
                                        href={login()}
                                        className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl border border-white/20 px-6 py-3.5 text-sm font-medium text-white hover:bg-white/10 transition-colors"
                                    >
                                        Ya tengo cuenta
                                    </Link>
                                )}
                ...
                <footer className="border-t border-border bg-background py-10">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <span>&copy; {new Date().getFullYear()} Nexo CRM Inmobiliario. Todos los derechos reservados.</span>
                        </div>
