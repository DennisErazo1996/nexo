    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación de dos factores ya está habilitada. Escanea el código QR o ingresa la clave de configuración en tu app autenticadora.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar de habilitar la autenticación de dos factores, escanea el código QR o ingresa la clave de configuración en tu app autenticadora',
            buttonText: 'Continuar',
        };
